...
if(opts.shadow==true){
_269.shadow=$("<div class=\"window-shadow\"><iframe style=\"position: absolute; z-index: -1;allowTransparency:true;background-color:#ffffff; width: 100%; height: 100%;scrolling:no;\" frameborder=\"0\"></iframe></div>").insertAfter(_269.window);	// changed 2015-11-02
...
(function($){
function init(_9ae){
var _9af=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"<span class=\"slider-max\"></span>"+"<span class=\"slider-mid\"></span>"+"<span class=\"slider-min\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_9ae);
var t=$(_9ae);
...
var max=_9cc.find(".slider-max");
var mid=_9cc.find(".slider-mid");
var min=_9cc.find(".slider-min");
if(opts.showTip){
tip.show();
tip.html(opts.tipFormatter.call(_9c9,opts.value));
max.html(opts.tipFormatter.call(_9c9,opts.max));
mid.html(opts.tipFormatter.call(_9c9,(opts.max+opts.min)/2));
min.html(opts.tipFormatter.call(_9c9,opts.min));
}else{
tip.hide();
}
if(opts.mode=="h"){
...
var _9cf="top:"+(pos - 15)+"px;";
_9cc.find(".slider-handle").attr("style",_9cf);
tip.attr("style",_9cf+"margin-top:10px");
}
if(_9cd!=_9ca){
...
$.fn.slider.defaults={width:"auto",height:"auto",mode:"v",reversed:false,showTip:false,disabled:false,value:0,min:0,max:100,step:1,rule:[],tipFormatter:function(_9e0){
return _9e0;
